...
const TENETS = [
  ...
  // { num: '二', title: '残業するなかれ', body: '定時に終わらない仕事は、まだイージーになっていない仕事である。真のイージー信者は、定時までに「イージーにする方法」を考え抜き、ノットイージーをイージーに定時に帰宅する。', verdict: '✦ 残業した場合の罰則：翌日早退してよい（イージーに帳消し）' },
  ...
  return (
    <>
      ...
      <div className="join-banner">
        ...
        <p className="join-disclaimer">※ イージー教は宗教法人ではありません。法的拘束力もありません。シーシャの強制もありません（推奨はします）。</p>
      </div>
    </>
  )
}
