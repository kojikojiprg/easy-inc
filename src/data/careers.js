...
export const culture = [
  ...
  { icon: '☕', title: 'シーシャは無限に出る', desc: 'オフィスのシーシャ台とフレーバーに上限はありません。吸いすぎ注意という規定もありません。全部会社持ちです。', quote: '"Shisha is a language in itself." — Jackie Chan（本当にこう言ったらしい）' },
]
...
export const jobs = [
  ...
  { id: 'job3', dept: 'Special',     type: '正社員', badge: '大注目', title: 'イージー推進部長（新設ポジション）',      location: 'オフィス（猫がいる）', salary: 'シーシャ代込み',       hours: '昼寝込み',    body: '社内の「難しいもの」を見つけて、「イージーにしろ」と言う役職です。具体的な解決策は考えなくていいです。「これイージーじゃない」と声に出すだけで、周囲が動きます。',             required: ['「これイージーじゃない」と言える勇気', '猫と仲良くできる（イージーみけとの面接あり）', '特になし'], welcomed: [], mailto: 'careers@easy-inc.jp?subject=イージー推進部長応募', cta: '部長になる →' },
